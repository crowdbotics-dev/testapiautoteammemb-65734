...
## Project Structure
    ...
    ├── testapiautoteammemb_65734  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_65734`
...
2. Clone this repo and `cd testapiautoteammemb_65734`
